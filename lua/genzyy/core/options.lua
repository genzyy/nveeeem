...
g.autoformat = true -- auto format

g.background = none

opt.clipboard = "unnamedplus" -- system clipboard
opt.completeopt = "menu,menuone,noselect"
opt.conceallevel = 3 -- hide markdown text formats
opt.confirm = true -- confirm when saving changes
...
opt.relativenumber = false -- disable relative number lines
